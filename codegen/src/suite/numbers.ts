...
const CURRENCIES: CurrencyType[] = ['USD', 'CAD', 'AUD', 'JPY', 'EUR', 'PTE'];
...
const DECADJ_MINFRAC = new Dimension<DecimalAdjustOptions>(
  'minimumFractionDigits',
  MIN_MAX,
);
const DECADJ_MAXFRAC = new Dimension<DecimalAdjustOptions>(
  'maximumFractionDigits',
  MIN_MAX,
);
const DECADJ_MINSIG = new Dimension<DecimalAdjustOptions>(
  'minimumSignificantDigits',
  MIN_MAX,
);
const DECADJ_MAXSIG = new Dimension<DecimalAdjustOptions>(
  'maximumSignificantDigits',
  MIN_MAX,
);

const NUMFMT_GROUP = new Dimension<NumberFormatOptions>('group', BOOLEANS);
const NUMFMT_TRIMZERO = new Dimension<NumberFormatOptions>(
  'trimZeroFractions',
  BOOLEANS,
);
const NUMFMT_NUM_SYSTEMS = new Dimension<NumberFormatOptions>(
  'nu',
  NUM_SYSTEMS,
);

const DECFMT_DIVISOR = new Dimension<DecimalFormatOptions>('divisor', DIVISORS);
const DECFMT_NEGZERO = new Dimension<DecimalFormatOptions>(
  'negativeZero',
  BOOLEANS,
);
const DECFMT_STYLE = new Dimension<DecimalFormatOptions>(
  'style',
  DECIMAL_STYLES,
);
const DECFMT_COMPACT_STYLE = new Dimension<DecimalFormatOptions>(
  'style',
  NUM_COMPACT_STYLE,
);
const DECFMT_MININT = new Dimension<DecimalFormatOptions>(
  'minimumIntegerDigits',
  MIN_MAX,
);

const CURFMT_STYLE = new Dimension<CurrencyFormatOptions>(
  'style',
  CURRENCY_STYLES,
);
const CURFMT_STYLE_COMPACT = new Dimension<CurrencyFormatOptions>(
  'style',
  CURRENCY_COMPACT_STYLES,
);
const CURFMT_DIVISOR = new Dimension<CurrencyFormatOptions>(
  'divisor',
  DIVISORS,
);
