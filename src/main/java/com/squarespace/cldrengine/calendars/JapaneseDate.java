...
public class JapaneseDate extends GregorianDate {
  ...
  public JapaneseDate(int firstDay, int minDays) {
    super(CalendarType.JAPANESE, firstDay, minDays);
  }
  ...
  public static JapaneseDate fromUnixEpoch(long epoch, String zoneId, int firstDay, int minDays) {
    return new JapaneseDate(firstDay, minDays)._initFromUnixEpoch(epoch, zoneId);
  }
  ...
  private static final int[] ERAS = new int[] {
      645, 6, 19, // Taika
      650, 2, 15, // Hakuchi
      672, 1, 1, // Hakuho
      686, 7, 20, // Shucho
